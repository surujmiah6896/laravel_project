                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="{{asset('uploads/profile_photo')}}/{{auth()->user()->profile_photo}}" width="20" alt="no photo"/>
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('catagory.create')}}">Add Cetegory</a></li>
                            <li><a href="{{route('catagory.index')}}">List Category</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('subcategory.create')}}">Add SubCetegory</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="{{route('variation.index')}}" aria-expanded="false">
						<i class="fa fa-th"></i>
