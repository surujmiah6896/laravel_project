            ...
            <div class="container position-relative">
                <div class="row">
                    ...
                    <div class="col align-self-center d-none d-lg-block">
                        <div class="main-menu">
                            <ul>
                                <li class="dropdown"><a href="{{route('fronted_home')}}">Home <i class="pe-7s-angle-down"></i></a>
                                    {{-- <ul class="sub-menu">
...
<!-- Content End Here-->
    ...
    <!-- Footer Area Start -->
    <div class="footer-area {{(Route::CurrentRouteName() == 'fronted_home')? 'm-lrb-30px' : ''}} ">
        <div class="footer-container">
            <div class="footer-top">
                <div class="container">
                    <div class="row">
                        <!-- Start single blog -->
                        <div class="col-md-6 col-lg-3 mb-lm-30px">
