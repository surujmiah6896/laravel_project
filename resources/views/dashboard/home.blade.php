								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2">Total Subcategory</p>
												<span class="title text-black font-w600">{{$total_subcategory}}</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2">Total Slider</p>
												<span class="title text-black font-w600">{{$total_slider}}</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
									...
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												...
												<span class="title text-black font-w600">{{$total_product}}</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
											<div class="progress-bar bg-secondary" style="width: 82%; height:5px;" role="progressbar">
