            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 text-center">
                    ...
                    <ul class="breadcrumb-list">
                        <li class="breadcrumb-item"><a href="{{route('fronted_home')}}">Home</a></li>
                ...
                <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                    ...
                    <div class="swiper-container zoom-top">
                        <div class="swiper-wrapper">
                                ...
                                <img class="img-responsive m-auto" src="{{asset('uploads/product_photo')}}/{{$product->product_thumbnail_photo}}"
                                    alt="">
                                </div>
                                    @foreach ($product_featured_photos as $product_featured_photo)
                                         <div class="swiper-slide zoom-image-hover">
                                            <img class="img-responsive m-auto" src="{{asset('uploads/product_featured_photos')}}/{{$product_featured_photo->product_featured_photo_name}}"
                                                alt="">
                                        </div>
                                    @endforeach
                ...
                <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="product-details-content quickview-content">
                        ...
                        <div class="pricing-meta">
                            <ul>
                                <li class="text-success">${{$product->discounted_price}}</li>
                                @if ($product->discounted_price != $product->regular_price)
                                     <s class="old">${{$product->regular_price}}</s>
                                @endif
                            </ul>
                        </div>
                        ...
                        <p class="m-0">
                            Available Stock: <span id="available_stock" class="badge bg-success"> {{$totalinventory}}</span>
                        </p>
                        ...
                        <div class="pro-details-quality">
                            ...
                            <div class="pro-details-cart">
                                <button id="card_btn" class="add-cart" href="#"> Add To
                                    Cart</button>
                            </div>
                            <div>
                                @auth
                                    <input id="login_status" type="hidden" name="yes" value ="yes" />
                                    @else
                                    <input id="login_status" type="hidden" name="no" value ="no" />
                                @endauth
                            </div>
                        ...
                        <div class="pro-details-categories-info pro-details-same-style d-flex">
                            ...
                            <ul class="d-flex">
                                <li>
                                    <a href="#">{{App\Models\catagory::find($product->category_id)->catagory_name}}</a>
                                </li>
                            </ul>
                        </div>
                        <div class="pro-details-categories-info pro-details-same-style d-flex">
                        ...
                        <div class="pro-details-social-info pro-details-same-style d-flex">
                            <span>Share: </span>
                            <ul class="d-flex">
                                <div class="fb-share-button" data-href="https://developers.facebook.com/docs/plugins/" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{url()->full()}}&src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
                                <li>
                                    {{-- <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{url()->full()}}&t={{$product->product_name}}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a> --}}
                                    {{-- <a href="http://www.facebook.com/sharer/sharer.php?u={{url()->full()}}&t={{$product->product_name}}" target="_blank" class="share-popup">Share on Facebook</a> --}}
                                </li>
                                <li>
                                    <a href="#"><i class="fa fa-twitter"></i></a>
                                </li>
                    ...
                    <div id="des-details2" class="tab-pane">
                        <div class="product-anotherinfo-wrapper text-start">
                            <ul>
                                ...
                                <li><span>Dimensions</span>{{$product->dimension}} cm</li>
        ...
        $('#card_btn').click(function(){
            ...
            if(cart_amount>available_stock){
                ...
                if(isNaN(cart_amount)){
                    Swal.fire(
                    'Please Select Color, Size and add your Quantity try again',
                    ...
                    if(cart_amount<=0){
                        Swal.fire(
                            'cart amount can not less then or equal 0!',
                            'You clicked the button!',
                            'success'
                            )
                    }else{
