    ...
    <div class="section ">
        <div class="hero-slider swiper-container slider-nav-style-1 slider-dot-style-1">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="hero-slide-item-2 slider-height swiper-slide d-flex {{($loop->even == 1 )?'bg-color1':'bg-color2'}}">
                    <div class="container align-self-center">

                        <div class="row">
                            <div class="col-xl-6 col-lg-5 col-md-5 col-sm-5 align-self-center sm-center-view">
                                <div class="hero-slide-content hero-slide-content-2 slider-animated-1">
                                    <span class="category">Sale {{$slider->sale_off_price}} %Off</span>
                                    <h2 class="title-1">{{$slider->slider_caption}}</h2>
                                    <a href="{{route('frontend.shop_left_sidebar')}}" class="btn btn-lg btn-primary btn-hover-dark"> Shop
                            ...
                            <div
                                ...
                                <div class="show-case">
                                    <div class="hero-slide-image">
                                        <img src="{{asset('uploads/slider_photo')}}/{{$slider->slider_photo}}" alt="no photo" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="product-tab-nav nav align-items-center justify-content-center">
                                <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab"
                                        ...
                                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                                                href="#tab-product-{{$category->id}}">{{$category->catagory_name}}</a>
                                        </li>
                                        @endforeach
            ...
            @foreach ($categories as $category)
             <div class="col-12 col-lg-4">
                <div class="single-banner-2">
                    <img src="{{asset('uploads/category_photo')}}/{{$category->catagory_photo}}" alt="">
                    <div class="item-disc">
                        <h4 class="title">{{$category->catagory_name}}</h4>
